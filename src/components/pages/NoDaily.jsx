...
export const NoDaily = () => {
    ...
    const [goDaily, setGoDaily] = useState(false);
    ...
    return (
        <div onClick={handleDaily} className="p-6 max-w-sm mx-auto bg-info rounded-xl shadow-lg flex items-center space-x-4">
